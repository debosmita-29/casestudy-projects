...
const projects = [
  {
    ...
    github:
      "https://github.com/debosmita-29/casestudy-projects/tree/main/casestudy-projects/debosmita-ai-portfolio-turborepo-startup-saas/apps/cogniintel",
...
- Better traceability from answer to source`
  },
  {
    ...
    github:
      "https://github.com/debosmita-29/casestudy-projects/tree/main/casestudy-projects/debosmita-ai-portfolio-turborepo-startup-saas/apps/quantumroute-ai",
...
- Allocation report generator`
  },
  {
    ...
    github:
      "https://github.com/debosmita-29/casestudy-projects/tree/main/casestudy-projects/debosmita-ai-portfolio-turborepo-startup-saas/apps/agentops-sentinel",
...
- Executive summary report`
  },
  {
    ...
    github:
      "https://github.com/debosmita-29/casestudy-projects/tree/main/casestudy-projects/debosmita-ai-portfolio-turborepo-startup-saas/apps/insightforge",
...
- KPI report output`
  },
  {
    ...
    github:
      "https://github.com/debosmita-29/casestudy-projects/tree/main/casestudy-projects/debosmita-ai-portfolio-turborepo-startup-saas/apps/neurorecruit",
    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-zinc-950 to-black text-white overflow-x-hidden">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-black/60 border-b border-zinc-800">
        <div className="flex justify-between items-center px-8 py-5 max-w-7xl mx-auto">
          ...
          <nav className="hidden md:flex gap-8 text-sm text-zinc-400">
            <a href="#hero" className={`transition ${active === "hero" ? "text-white" : "text-zinc-400"}`}>
              Home
            </a>
            <a href="#projects" className={`transition ${active === "projects" ? "text-white" : "text-zinc-400"}`}>
              Projects
            </a>
            <a href="#about" className={`transition ${active === "about" ? "text-white" : "text-zinc-400"}`}>
              About Me
            </a>
      ...
      <section id="hero" className="px-8 py-32 max-w-7xl mx-auto text-center">
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-bold tracking-tight bg-gradient-to-r from-white via-zinc-300 to-zinc-500 text-transparent bg-clip-text leading-tight"
        >
        ...
        {projects.map((project, index) => (
          ...
          >
            ...
            <div className="p-7">
              ...
              <p className="text-zinc-400 mt-3 leading-7">{project.desc}</p>
      ...
      <section id="impact" className="px-8 py-32 max-w-6xl mx-auto text-center">
        ...
        <p className="mt-8 text-zinc-300 max-w-4xl mx-auto text-xl leading-9">
          Designing production-scale agentic AI systems for enterprise knowledge
          extraction, optimization, observability, and intelligent automation.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-16">
          <div className="rounded-3xl bg-zinc-900 border border-zinc-800 p-8">
            ...
            <p className="mt-3 text-zinc-400">
              Reduction in AI-assisted engineering workflows
            </p>
          </div>
          <div className="rounded-3xl bg-zinc-900 border border-zinc-800 p-8">
            <h3 className="text-4xl font-bold">5+</h3>
            <p className="mt-3 text-zinc-400">
              Enterprise-grade AI SaaS platforms architected
            </p>
          </div>
          <div className="rounded-3xl bg-zinc-900 border border-zinc-800 p-8">
            <h3 className="text-4xl font-bold">99.3%</h3>
            <p className="mt-3 text-zinc-400">
              Regression stability through intelligent automation
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="about" className="px-8 py-28 max-w-6xl mx-auto">
        <div className="rounded-[2rem] bg-gradient-to-br from-zinc-900 to-black border border-zinc-800 p-8 md:p-12 shadow-2xl">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mt-4">
            AI Engineer by heart. Builder of systems that think, learn, and
            scale.
          </h2>
          <p className="mt-8 text-zinc-300 text-lg leading-8">
            My story sits at the intersection of engineering discipline and AI
            imagination. I started with deep foundations in software
            engineering, testing, automation, platforms, telecommunications,
            and enterprise systems, then evolved into building Agentic AI,
            RAG-backed intelligence, multi-agent orchestration, and autonomous
            SaaS platforms.
          </p>
          <p className="mt-5 text-zinc-300 text-lg leading-8">
            What drives me is the ability to turn complexity into intelligent
            systems: agents that reason, pipelines that retrieve the right
            knowledge, dashboards that explain operational signals, and
            platforms that help teams move from manual effort to autonomous
            execution. I build with a product mindset, an architect’s eye, and a
            bias toward measurable enterprise impact.
          </p>
          <p className="mt-6 text-xl text-white font-semibold">
            My north star: build AI systems that are not just impressive demos,
            but useful, reliable, observable, and ready for real business
            outcomes.
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="rounded-[2rem] bg-zinc-900 border border-zinc-800 p-8 md:p-10">
            ...
            <p className="mt-6 text-zinc-300 leading-8 text-lg">
              I’m always open to meaningful conversations around Agentic AI,
              enterprise RAG, AI-native SaaS platforms, intelligent automation,
              and leadership-level AI transformation.
            </p>
          </div>
