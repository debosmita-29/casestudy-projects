...
def llm_summarize(prompt: str) -> str:
        ...
        try:
            ...
            response = client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are a concise distributed AI infrastructure analyst.",
                    },
    ...
    return (
        "Mock LLM summary: AlignOps identifies underutilized accelerators, unstable alignment runs, "
        "inference bottlenecks, and cost-aware optimization actions from local telemetry."
    )
