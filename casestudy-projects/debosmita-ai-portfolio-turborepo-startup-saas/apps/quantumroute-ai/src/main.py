...
SERVICE_NAME = "QuantumRoute AI"
SERVICE_DESC = "Constraint-aware scheduling optimizer"
...
@app.get("/")
def root():
    return {"service": SERVICE_NAME, "docs": "/docs", "health": "/health", "demo_endpoint": "/optimize"}
